...
namespace WebApiClient
{
    public class IoHelper
    {
        ...
        {
            GenerateThumb(imagePath, thumbPath, width, height, mode, RotateFlipType.RotateNoneFlipNone);
        }
        ...
        /// <param name="height">缩略图高度</param>
        /// <param name="mode">生成缩略图的方式</param>   
        public static void GenerateThumb(string imagePath, string thumbPath, int width, int height, string mode, RotateFlipType rotateflip)
        {
